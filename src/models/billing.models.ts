...
export const PaymentLink = mongoose.model<IPaymentLinkDoc>('PaymentLink', PaymentLinkSchema);
...
export const ApiToken = mongoose.model<IApiTokenDoc>('ApiToken', ApiTokenSchema);
...
export const WebhookLog = mongoose.model<IWebhookLogDoc>('WebhookLog', WebhookLogSchema);
